...
export default function DailyTask() {
    ...
    const manifestUrl = "https://crtgame.vercel.app/tonconnect-manifest.json";
                ...
                >
                    <div className="w-full max-w-[500px] px-[3%] py-[3%] flex justify-between items-end relative bg-[#E55E00] ">
                        <div className=" flex flex-col  ">
                            <p className="text-white text-[4.5vmin] sm:text-[3.5vmin] xs:text-[4.5vmin]">Pencil Factory</p>
                    ...
                    <div className="w-full h-[20%] px-[3%] py-[1%] flex flex-col justify-between items-start ">
                        <div className=" w-full flex flex-col ">
                            <p className="text-white text-[4vmin] sm:text-[2vmin] xs:text-[4.5vmin] text-center"><span className="font-bold">Use  CRT to purchase a participation Ai pencil.<br /></span>
                    ...
                    <div className=" w-full h-[60%] px-[2%]  flex flex-col items-center " >
                        <div className=" w-full h-full flex flex-col justify-evenly items-center relative gap-2">
                            ...
                            <div className=" w-[90%] relative flex justify-between items-center">
                                <div className=" w-[13vmin] sm:w-[7vmin] aspect-[1/1] relative ">
                                    <Image
                            ...
                            <div className=" w-[90%] px-[5%] flex flex-col justify-center items-center bg-white rounded-[23px]">
                                <div className=" w-full flex justify-between items-center border-b-[0.5px] border-b-black py-[2%]">
                                    <div className=" w-[12vmin] sm:w-[6vmin] aspect-[1/1] relative ">
                                        <Image
                                            src="/image/crt_game.svg"
                                            alt="meatIcon"
                                            layout="fill"
                                    ...
                                    <div className=" flex flex-col items-start w-[55%] ">
                                        ...
                                        <p className=" text-[1.8vmax] xs:text-[1.5vmax] sm:text-[1.9vmin] text-[#C0C0C0]">100 CRT</p>
                                    </div>
                                ...
                                <div className=" w-full flex justify-between items-center py-[2%] ">
                                    ...
                                    <div className=" flex flex-col items-start w-[55%] ">
                                        ...
                                        <p className=" text-[1.8vmax] xs:text-[1.5vmax] sm:text-[1.9vmin] text-[#C0C0C0]">1 CRT</p>
                                    </div>
                                    <a href="https://x.com/CRTProject_X" target="_blank" rel="noopener noreferrer" className={` w-[20%] bg-[#767DFF] h-[50%] rounded-3xl relative duration-300 transition-all ${disabledDaily[1] ? 'opacity-100' : 'opacity-20'}`}>
                            ...
                            <div className=" w-[90%] relative flex justify-between items-center">
                                <div className=" w-[14vmin] sm:w-[8vmin] aspect-[1/1] relative ">
                                    <Image
                                        src="/image/crt_game.svg"
                                        alt="meatIcon"
                                        layout="fill"
                            ...
                            <div className=" w-[90%] px-[5%] flex flex-col justify-center items-center bg-white rounded-[23px]">
                                <div className=" w-full flex justify-between items-center border-b-[0.5px] border-b-black py-[2%]">
                                    ...
                                    <div className=" flex flex-col items-start w-[55%] ">
                                        ...
                                        <p className=" text-[1.8vmax] xs:text-[1.5vmax] sm:text-[1.9vmin] text-[#C0C0C0]">1K CRT</p>
                                    </div>
                                    <a href="https://x.com/CRTProject_X" target="_blank" rel="noopener noreferrer" className={` w-[20%] bg-[#767DFF] h-[50%] rounded-3xl relative duration-300 transition-all ${disabledTask[0] ? 'opacity-100' : 'opacity-20'}`}>
                                ...
                                <div className=" w-full flex justify-between items-center py-[2%] ">
                                    ...
                                    <div className=" flex flex-col items-start w-[55%] ">
                                        ...
                                        <p className=" text-[1.8vmax] xs:text-[1.5vmax] sm:text-[1.9vmin] text-[#C0C0C0]">5k CRT | {inviteCount}/5users</p>
                                    </div>
